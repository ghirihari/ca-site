  ...
  return (
    <div className="container-fluid">
      <div className='row banner'>
        ...
        <label className="bannerText col-12 col-lg-9 d-lg-none">Get in touch with us</label>
        <label className="bannerText col-12 col-lg-9 d-none d-lg-block">Having a query? Please reach out to us.</label>
